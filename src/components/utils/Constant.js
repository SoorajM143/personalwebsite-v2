...
const APPLICATION_CONST = {
  ...
  MAIN_PAGE_MESSAGE_1: "I'm always open to discussing new ideas and opportunities ",
  MAIN_PAGE_MESSAGE_2: 'Interested in working together? ',
  MAIN_PAGE_MESSAGE_3: 'We should queue up for a time to chat.',
