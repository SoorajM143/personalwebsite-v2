        ...
        <div className="nav__content">
          ...
          <ul className="nav__list">
            <li className="nav__list_desc">
              ...
              <span id="desc_home" className="desc_link_item">
            ...
            <li className="nav__list_desc">
              ...
              <span id="desc_about" className="desc_link_item">
            ...
            <li className="nav__list_desc">
              ...
              <span id="desc_work" className="desc_link_item">
                History of my work
              </span>
            </li>
            <li className="nav__list_desc">
              ...
              <span id="desc_contact" className="desc_link_item">
